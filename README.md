...
```bash
git clone https://github.com/MahmudGalib7/dotfiles.git ~/.dotfiles
```
...
> [!Important]
> If you want to use my neovim configurations, then please read its [README.md](./nvim/.config/nvim/README.md)
